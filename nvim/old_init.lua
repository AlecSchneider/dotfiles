...
vim.keymap.set('n', '<space>q', '<cmd>wq<cr>', { desc = 'Quit' })
...
local function run()
  if vim.bo.filetype == 'python' then
    vim.cmd ':vsp | term python3 %'
    vim.cmd ':star'
  end
end

vim.keymap.set({ 'n', 'v' }, '<space>r', run)
...
vim.cmd [[hi VertSplit ctermbg=NONE guibg=NONE cterm=NONE]]
