...
vim.keymap.set('n', '<C-h>', ':call TmuxMove("h")<cr>', { silent = true })
vim.keymap.set('n', '<C-j>', ':call TmuxMove("j")<cr>', { silent = true })
vim.keymap.set('n', '<C-k>', ':call TmuxMove("k")<cr>', { silent = true })
vim.keymap.set('n', '<C-l>', ':call TmuxMove("l")<cr>', { silent = true })
...
vim.cmd [[highlight ColorColumn ctermbg=0 guibg=#073642]]
